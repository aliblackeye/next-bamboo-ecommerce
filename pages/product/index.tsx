...
const Product: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="container py-[12.5rem] px-5">
        <div className="flex">
          <Swiper
            cssMode={true}
            navigation={true}
            ...
            className="product-swiper !h-[50rem] !w-[38.125rem]">
            <SwiperSlide>
              <div className="h-[50rem] w-[38.125rem]">
                <img
                  src="/images/p1.png"
      ...
      <div className="container mx-auto p-5">
        <div>
          <h1 className="mb-[3.375rem] text-[3rem] font-header text-center">Related Product</h1>
          <div className="mt-5">
            <Swiper
              slidesPerView={3}
